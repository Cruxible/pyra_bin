...
class FileChooser_Extract_Audio(Gtk.Window):
    def __init__(self, treeview_window):
        ...
        css = """
        #first_button, #second_button, #update_Label {
          font-size: 20px;
        }
        """
            ...
            if response == Gtk.ResponseType.CANCEL:
                ...
                if not output_filename.endswith('.mp3'):
                    ...
                    def extract_audio_func():
                        ...
                        self.video_file = None
                        self.button2.set_sensitive(False)
                        self.message_label.set_text(f"Audio extraction completed successfully!\n{output_filename}")   
