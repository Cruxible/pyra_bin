...
class FileChooser_Cut_Vid(Gtk.Window):
    def __init__(self, treeview_window):
        ...
        # Add another button
        self.button2 = Gtk.Button.new_with_label("Can't click me yet")
    ...
    def on_file_clicked(self, widget):
        ...
        if response == Gtk.ResponseType.CANCEL:
            ...
            clip = VideoFileClip(self.dialog.get_filename())
            ...
            if filename is not None:
                ...
                if response == Gtk.ResponseType.CANCEL:
                    ...
                    if not output_filename.endswith('.mp4'):
                        self.message_label.set_text("Output filename does not end with .mp4")
                    else:
                        ...
                        # Run the video cutter in a separate thread
